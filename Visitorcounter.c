...
void main()
{
	...
	while(1)
	{
		if(s1==0)// this condition will become true if, first sensor o/p will become HIGH at first.
		...
		else if(s2==0)// this condition will become true if, secont sensor o/p will become HIGH at first.
		{
